    ...
    <table id="example" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
        ...
        <tbody>
        	...
        	<tr>
                <td><?=$i?></td>
                <td><?=$q['question']?></td>
                <!--<td><a href="<?=base_url('FeedbackController/delete_question/').$q['q_id'];?>">Delete</a></td>  
                <td><a href="<?=base_url('FeedbackController/update_question/').$q['q_id'];?>">Delete</a></td> -->
                  <td align="middle"><button type="button" id="b1<?=$q['q_id']; ?>" class="btn <?php echo $q['active']?'btn-info':'btn-danger'; ?>" onclick="change_state(<?=$q['q_id']?>)"><span id="stateus_sp_<?=$q['q_id']; ?>"><?php echo $q['active']?'Active':'Inactive';?></span></button></td>
            </tr>
            <?php
            $i++;
        }
			...
			<!--/down-->
                           ...
                           <div style="height: 100%"></div>
							...
							<script> 
                                ...
                                $.ajax({
                                    type:"POST",
                                    url: "<?php echo base_url()?>admin/change_status_question",
                                    data:{id:id},
