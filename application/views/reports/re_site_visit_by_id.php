...
<div class="container">
    ...
    <div class="col-md-12">
		...
		<table class="display" cellspacing="0" width="50%" style="margin:0 auto;">
			...
			<td><?php $p = $this->callback_model->getWhere(array('id'=>$value['project_id']),"project");
			echo $p[0]->name;  ?></td>
			<td><?php $p = $this->callback_model->getWhere(array('id'=>$value['lead_source_id']),"lead_source");
			echo $p[0]->name;  ?></td>
			<td><?php $p = $this->callback_model->getWhere(array('id'=>$value['status_id']),"status");
			echo $p[0]->name;  ?></td> 
					 	</tr>
						<?php 
					} 
