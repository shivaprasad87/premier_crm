...
<div class="container">
	...
	<form method="GET" action="<?php echo base_url()?>admin/generate_report">
    	...
    	<?php } ?>
        <div class="col-sm-3 form-group pull-right"><br/>
					...
					foreach ($callbackData as $key => $value) {							
						...
						?>
					 	<tr>
					 		...
					 		<td><a href="<?= base_url('admin/view_callbacks_lists?userId='.$value['userId'].'&fromDate='.$startDate.'&endDate='.$endDate) ?>" target="_blank"><?= $value['totalCalls']; ?></a></td>
					 	</tr>
						<?php 
					} 
					?>
