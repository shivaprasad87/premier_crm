...
<body>
	<div class="container">
	    ...
	    <div class="col-md-12">
	    	...
	    	?>
	    	<center>    		
			    <h4>Face to Face Site Visit Report</h4>
				<p ><?= $title; ?></p>
	    	</center>	
								...
								if(!in_array($value->emp_code, $idsArry)) {
									?>
								 	<tr>
								 		...
								 		<td>
								 			<a href="<?= base_url('admin/view-site-visit-data?userid='.$value->userId.'&fromDate='.$startDate.'&endDate='.$endDate.'&reportType=face-to-face') ?>" target="_blank">
								 				<?php echo $facetofacesCount[$value->emp_code]; ?>
								 			</a>
								 		</td>
								 	</tr>
									<?php
