...
<title>CRM Premier Real Estate | Login</title>
                ...
                <?php } ?>
                         ...
                         <!--  <img src="<?php echo base_url()?>assets/img/logo.png"style="width: 35%;padding: 11px;margin-top: -30px;"> -->
										...
										<div class="footer">
										   ...
										   <p>&copy <?= date('Y')?> Premier Real Estate . All Rights Reserved | Design by <a href="#" target="_blank">Premier Real Estate Soultions</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
